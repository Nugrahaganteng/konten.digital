...
<div class="main">
    <div class="topbar">
        <div>
            ...
            <div class="topbar-breadcrumb">Admin / Artikel / Edit: {{ Str::limit($article->title, 40) }}</div>
        </div>
            ...
            <form action="{{ route('admin.articles.update', $article) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="field-group">
                    ...
                    @if($article->thumbnail)
                        <img src="{{ asset('storage/'.$article->thumbnail) }}" class="current-thumb" alt="thumbnail saat ini">
                        <div class="field-hint" style="margin-bottom:0.5rem;">Thumbnail saat ini. Upload baru untuk mengganti.</div>
                    @endif
                ...
                <div class="field-group">
                    ...
                    <textarea id="excerpt" name="excerpt" class="field" style="min-height:80px;"
                              maxlength="300" oninput="updateCharCount(this,'excerpt-count',300)">{{ old('excerpt',$article->excerpt) }}</textarea>
                ...
                <div class="field-group">
                    ...
                    <textarea id="content" name="content" class="field" required
                              oninput="updateCharCount(this,'content-count',null)">{{ old('content',$article->content) }}</textarea>
