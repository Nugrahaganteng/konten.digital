...
// robots.txt → dilayani langsung dari public/robots.txt (file statis)
...
Route::middleware(['auth', 'admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // ── CMS: Toggle field visibility (AJAX) ──────────────────
    ...
    // ── CMS: Services ─────────────────────────────────────────
    // PENTING: route statis harus SEBELUM route {service}
    ...
    // ── CMS: Page Sections ────────────────────────────────────
    // PENTING: route statis harus SEBELUM route {pageSection}
