    ...
    <style>
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        @media (max-width: 600px) {
            ...
            .topbar-actions { display: none !important; } /* Sembunyikan tombol lihat/kembali di topbar mobile agar tidak sesak */
        ...
        <div class="topbar">
            ...
            <div class="topbar-actions" style="display:flex; gap:0.75rem; align-items:center;">
                <a href="{{ route('articles.show', $article->slug) }}" target="_blank"
                   style="font-family:'Anton',sans-serif; font-size:0.75rem; letter-spacing:0.1em; color:var(--purple); text-decoration:none; border:2px solid var(--ink); padding:0.5rem 1rem; background:var(--yellow);">
                   👁 LIHAT
                </a>
