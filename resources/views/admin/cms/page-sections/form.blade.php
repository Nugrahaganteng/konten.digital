...
<div class="p-6 max-w-2xl mx-auto">
    ...
    {{-- Breadcrumb --}}
    <div class="mb-6">
        <nav class="text-sm text-gray-400 mb-1 flex items-center gap-1 flex-wrap">
            ...
            <a href="{{ route('admin.cms.page-sections.index', ['page' => $section->page]) }}"
               class="hover:text-blue-600 transition capitalize">{{ ucfirst(str_replace('-', ' ', $section->page)) }}</a>
            <span>/</span>
