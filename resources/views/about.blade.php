...
@php
    ...
    $tv = fn($k, $d = '') => $tentangS ? ($tentangS->get($k) ?: $d) : $d;
    $vm = fn($k, $d = '') => $vmS      ? ($vmS->get($k)      ?: $d) : $d;
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="relative reveal group">
                <div class="border-4 border-yellow-400 bg-yellow-400 overflow-hidden aspect-[4/3]
                    ...
                    @if($tentangS && $tentangS->get('image'))
                        <img src="{{ Storage::url($tentangS->get('image')) }}"
                             alt="{{ $tv('title', 'Tim') }}"
