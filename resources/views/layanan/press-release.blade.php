...
{{-- SECTION: TARGET AUDIENCE (LIGHT ARCADE STYLE) --}}
<section class="py-24 bg-[#F0F0F0] border-y-8 border-black relative overflow-hidden">
    {{-- Dekorasi Polkadot Lembut di Latar Belakang --}}
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="group relative bg-white border-4 border-black p-8 transition-all duration-200 hover:-translate-y-2 hover:-translate-x-1 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[10px_10px_0px_0px_rgba(0,0,0,1)]">
                ...
                {{-- Ikon Dengan Background Bulat Kaku --}}
                ...
                <h4 class="text-black text-2xl font-black uppercase mb-3 tracking-tighter leading-none">
                    {{ $t['title'] }}
                </h4>
                
                <p class="text-black/70 text-sm font-bold leading-relaxed mb-6">
                    {{ $t['desc'] }}
                </p>
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="{{ $f['color'] }} border-4 border-black p-6 group hover:-translate-y-2 hover:-translate-x-2 transition-all duration-200 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] hover:shadow-[15px_15px_0px_0px_rgba(0,0,0,1)]">
                ...
                <p class="text-sm font-bold text-black/80 leading-snug">
                    {{ $f['desc'] }}
                </p>
            </div>
            @endforeach
    ...
    <div class="max-w-7xl mx-auto px-6 text-center">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div class="bg-white border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col h-full">
                ...
                <a href="https://api.whatsapp.com/send?phone=6287786000919" class="mt-auto block w-full bg-gradient-to-r from-cyan-400 to-purple-500 text-white py-3 font-black uppercase text-sm rounded-lg border-2 border-black">Konsultasi Sekarang</a>
            </div>
            ...
            <div class="bg-white border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col h-full">
                ...
                <a href="https://api.whatsapp.com/send?phone=6287786000919" class="mt-auto block w-full bg-[#333] text-white py-3 font-black uppercase text-sm rounded-lg border-2 border-black">Konsultasi Sekarang</a>
            </div>
            ...
            <div class="bg-white border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col h-full">
                ...
                <a href="https://api.whatsapp.com/send?phone=6287786000919" class="mt-auto block w-full bg-yellow-600 text-white py-3 font-black uppercase text-sm rounded-lg border-2 border-black">Konsultasi Sekarang</a>
            </div>
            ...
            <div class="bg-white border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col h-full">
                ...
                <a href="https://api.whatsapp.com/send?phone=6287786000919" class="mt-auto block w-full bg-gradient-to-r from-cyan-400 to-blue-700 text-white py-3 font-black uppercase text-sm rounded-lg border-2 border-black">Konsultasi Sekarang</a>
            </div>
        </div>
    </div>
</section>
...
<section class="bg-purple-950 border-b-4 border-black py-20 px-6 lg:px-16 relative overflow-hidden bg-space-stars" id="clients">
    <div class="max-w-7xl mx-auto relative z-10">
        ...
        {{-- Header Ala Arcade --}}
        <div class="flex flex-col md:flex-row border-4 border-black shadow-neo mb-12">
            {{-- Bagian Judul Kiri --}}
            ...
            {{-- Bagian Animasi Ticker Kanan (Ikon Clean) --}}
            <div class="bg-yellow-400 flex-1 relative overflow-hidden flex items-center py-4 px-6">
                ...
                <div class="relative w-full h-full flex items-center overflow-hidden">
                    <div class="animate-ticker w-max flex items-center gap-12 text-purple-950">
                        @for($i=0; $i<6; $i++)
                            {{-- Menggunakan Karakter SVG/Font Awesome atau Simbol Geometris Tajam --}}
        ...
        {{-- Grid Logo Klien --}}
        <div class="border-4 border-black bg-black shadow-neo">
