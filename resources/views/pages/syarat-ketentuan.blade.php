...
@php
    ...
    $syaratS = $sections->get('syarat_pr');
    ...
    <div class="max-w-7xl mx-auto px-6 grid md:grid-cols-12 gap-12 items-center">
        ...
        <div class="md:col-span-7">
            ...
            <div class="grid md:grid-cols-1 gap-4">
                @foreach($articleRules as $rule)
                <div class="flex items-center gap-4 group">
                    <div class="w-8 h-8 bg-black border-2 border-black flex items-center justify-center group-hover:bg-[#FFD200] transition-colors shrink-0">
